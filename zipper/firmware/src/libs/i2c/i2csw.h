...
/// u08s.  Thanks to the standardization of the I2C protocol and register
...
u08 i2cSend(u08 device, u08 subAddr, u08 length, u08 *data);

// receive I2C data from <device> register <sub>
u08 i2cReceive(u08 device, u08 subAddr, u08 length, u08 *data);
