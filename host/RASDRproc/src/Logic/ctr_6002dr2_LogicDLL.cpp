...
{
    if(CLOSE_DEBUG) cout << "Entering LMAL_Quit()" << endl;
	if(mainModule) {
/*		delete mainModule->getTransmitter();
		cout << "After Transmitter Delete" << endl;*/
		delete mainModule;
		if(CLOSE_DEBUG) cout << "mainModule deleted" << endl;
        mainModule = NULL;}
}
