...
void pnlADF::OncmbABWSelected(wxCommandEvent& event)
{
}

void pnlADF::OncmbCS1_fSelected(wxCommandEvent& event)
{
}

void pnlADF::OncmbTC_fSelected(wxCommandEvent& event)
{
}

void pnlADF::OnrgrCR_iSelect(wxCommandEvent& event)
{
}

void pnlADF::OnrgrPD2_fSelect(wxCommandEvent& event)
{
}

void pnlADF::OnrgrPD1_iSelect(wxCommandEvent& event)
{
}
