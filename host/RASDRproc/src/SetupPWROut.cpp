...
//	OutputFile = new wxFilePickerCtrl(this, ID_FILEPICKERCTRL1, _T("PowerOut.csv"), wxEmptyString, _T("*.csv"), wxDefaultPosition, wxDefaultSize, wxFLP_OPEN|wxFLP_USE_TEXTCTRL, wxDefaultValidator, _T("ID_FILEPICKERCTRL1"));
